...
namespace Dapr.Workflow.Starter.API.Migrations
{
    ...
    [Migration("20231111125343_InitialMigration-3")]
            ...
            modelBuilder.Entity("Dapr.Workflow.Starter.API.DataAccess.Models.Inventory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 11, 11, 18, 23, 43, 147, DateTimeKind.Local).AddTicks(5408),
                            ProductId = 1,
                            UpdatedTime = new DateTime(2023, 11, 11, 18, 23, 43, 147, DateTimeKind.Local).AddTicks(5418),
                            stock = 10
                        },
                        new
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 11, 11, 18, 23, 43, 147, DateTimeKind.Local).AddTicks(5419),
                            ProductId = 2,
                            UpdatedTime = new DateTime(2023, 11, 11, 18, 23, 43, 147, DateTimeKind.Local).AddTicks(5420),
                            stock = 10
                        },
                        new
                        {
                            Id = 3,
                            CreatedTime = new DateTime(2023, 11, 11, 18, 23, 43, 147, DateTimeKind.Local).AddTicks(5421),
                            ProductId = 3,
                            UpdatedTime = new DateTime(2023, 11, 11, 18, 23, 43, 147, DateTimeKind.Local).AddTicks(5422),
                            stock = 10
                        });
                });
