...
namespace Dapr.Workflow.Starter.API.Migrations
{
    ...
    [Migration("20231107141441_InitialMigration-1")]
            ...
            modelBuilder.Entity("Dapr.Workflow.Starter.API.DataAccess.Models.Inventory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 11, 7, 19, 44, 41, 750, DateTimeKind.Local).AddTicks(4436),
                            ProductId = 1,
                            UpdatedTime = new DateTime(2023, 11, 7, 19, 44, 41, 750, DateTimeKind.Local).AddTicks(4458),
                            stock = 10
                        },
                        new
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 11, 7, 19, 44, 41, 750, DateTimeKind.Local).AddTicks(4460),
                            ProductId = 2,
                            UpdatedTime = new DateTime(2023, 11, 7, 19, 44, 41, 750, DateTimeKind.Local).AddTicks(4460),
                            stock = 10
                        },
                        new
                        {
                            Id = 3,
                            CreatedTime = new DateTime(2023, 11, 7, 19, 44, 41, 750, DateTimeKind.Local).AddTicks(4461),
                            ProductId = 3,
                            UpdatedTime = new DateTime(2023, 11, 7, 19, 44, 41, 750, DateTimeKind.Local).AddTicks(4462),
                            stock = 10
                        });
                });
